...
from lit.datamodules import UCG2CGDataModule
from lit.modules import LitUCG2CGNoiseNet
from glob import glob

datamodule = UCG2CGDataModule(
    cg_files       = sorted(glob('/p/gpfs1/hsu16/admirral/data/processed/dimers-C/cg/chunk-[!0]*.npy')),
    ucg_index_file = './configs/ucg-index-dimer.txt',
    batch_size     = 64,
    num_workers    = 8,
    train_size     = 0.9,
)
